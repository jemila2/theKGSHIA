...
// imapSimple.connect(config).then((connection) => {
  
//     setInterval(() => {
//         connection.search(['UNSEEN'], { markSeen: false }).then((messages) => {
//             messages.forEach((message) => {
//                 connection.fetch(message.dirty, { bodies: ['1'], markSeen: true }).then((results) => {
//                     results.forEach((result) => {
//                         simpleParser(result.parts[0].body, (err, parsed) => {
//                             if (err) {
